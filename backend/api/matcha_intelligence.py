...
_ORACLE_QA = [
    ...
    (r"(?i)(wholesale|bulk|cafe|カフェ|卸|業務用|ホールセール)", {
        "en": "NAKAI offers wholesale matcha for cafes, restaurants, hotels, and retailers. 6 wholesale products across 3 grade tiers. Quantities from 5kg to 1+ metric ton. Contact: wholesale@nakaiinfo.com or submit an inquiry at matcha.ai/wholesale-inquiry",
        "ja": "NAKAIはカフェ、レストラン、ホテル、小売店向けの卸売抹茶を提供しています。3つのグレードにわたる6つの卸売製品。5kgから1トン以上まで。お問合せ: wholesale@nakaiinfo.com またはmatcha.ai/wholesale-inquiry",
    }),
...
@intelligence_router.get(
    ...
    description="One-line JavaScript embed that adds a matcha knowledge assistant to any website. <script src='https://matcha.ai/api/oracle/embed.js'></script>",
)
