...
(function(){{
  ...
  var en={{
    ...
    sLink:'\\u2190 Back to Wholesale Collection',back:'Back',note:'Prefer email? <a href="mailto:wholesale@nakaiinfo.com">wholesale@nakaiinfo.com</a>',
